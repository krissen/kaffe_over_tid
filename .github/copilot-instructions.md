# Copilot Instructions for kaffe_over_tid
...
**Language**: Swedish UI/comments/errors, English variable/function names. Key terms: koppar=cups, tid=time, lägg till=add. Preserve this.
