...
#### Färgpalett
Baserad på Moccamaster's varumärkesfärger:
- **Primärfärg**: `#c8102e` (Moccamaster röd)
- **Sekundärfärg**: `#2c3e50` (Mörk blå-grå)
- **Bakgrund**: `#f5f5f0` (Varm off-white)
- **Text**: `#2c2c2c` (Mörk grå)

#### Stiländringar (www/styles.css)
- Modern, ren typografi med Helvetica Neue
- Retro-inspirerad design med subtila skuggor och rundade hörn
- Responsiv design för olika skärmstorlekar
- Smooth transitions och hover-effekter
- Custom-stilade tabeller, knappar och formulärelement
- Info-boxar med färgkodning
...
#### Knappar
- Primära knappar i Moccamaster-rött
- Hover-effekter med lätt lift
- Sekundära knappar (nedladdning) i grönt

#### Flikar (Tabs)
- Modernare tab-design
- Aktiv tab i Moccamaster-röd färg
- Smooth transitions
...
```
www/
├── favicon.ico          # 32x32 favicon från Moccamaster-logo
├── moccamaster_logo.png # Logotyp för header (225x225)
